...
public class CurrationTeamAdapter extends RecyclerView.Adapter<CurrationTeamAdapter.ListViewHolder> {
    private List<Team> mTeamList;
    private CurrationFragment mContext;

    public CurrationTeamAdapter(List<Team> mTeamList, CurrationFragment mContext) {
