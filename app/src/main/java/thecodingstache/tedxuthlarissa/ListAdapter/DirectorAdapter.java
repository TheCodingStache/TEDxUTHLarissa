...
public class DirectorAdapter extends RecyclerView.Adapter<DirectorAdapter.ListViewHolder> {
    private List<Team> mTeamList;
    private DirectorsFragment mContext;

    public DirectorAdapter(List<Team> mTeamList, DirectorsFragment mContext) {
